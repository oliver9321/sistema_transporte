                                ...
                                <a href="index.php?c=Payments&a=Index">
                                    <div class="card report-card bg-dark">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">                                                
                                                <div class="col">
                                                    <p class="text-white mb-0 fw-semibold">Payments</p>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="card-body border-bottom-dashed">
                                    <div class="earning-data text-center">
                                        ...
                                        <p class="text-muted font-15 mb-4">Total movements</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive browser_users">
                                        ...
                                        <table id="OrdersPickeUp" class="table-light nowrap" style="width:100%" >
                                            <thead>
                                            <tr>
                                                    <th></th>
                                                    <th class="text-center">Order ID</th>
...
<script>
 ...
 $('#OrdersPending').DataTable({
   ...
   /* $('#OrdersPickeUp').DataTable({
      ...
      "bDestroy": true,
            "ajax": {
                "url": "index.php?c=Orders&a=OrderPickedUp",
            },
        columns:[
            {data: "Id"},
            {data: "Id"},
