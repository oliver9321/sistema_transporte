                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bg-primary">
                                                <h6 class="modal-title m-0" id="exampleModalDefaultLabel"> <i class="fas fa-user-plus me-2"></i> New customer</h6>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <!--end modal-header-->
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                                ...
                                                                <input type="tel" class="form-control" id="Phone1" name="Phone1" placeholder="+123456789" aria-describedby="basic-addon1">
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                                <span class="input-group-text"><i class="las la-phone"></i></span>
                                                                <input type="tel" class="form-control" id="Phone2" name="Phone2" placeholder="+123456789" aria-describedby="basic-addon1">
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                                ...
                                                                <input type="email" class="form-control" id="Email" name="Email" placeholder="oliver@domain.com" aria-describedby="basic-addon1">
                                                            </div>
                                                    </div>
                                                </div>
                                                    </div>
