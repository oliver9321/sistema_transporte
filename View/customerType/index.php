   ...
   <div class="col-12">
      <div class="card">
          <div class="card-header">
            ...
            <div class="card-body">  
                <table id="customerTypeList" width="100%" class="table table-striped table-bordered dataTable">
                    <thead>
    ...
    $('#customerTypeList').DataTable({
        ...
        columns:[
            ...
            "render": function ( data) {
                return '<a class="btn btn-warning" href="index.php?c=customerType&a=Edit&Id='+data+'" aria-label="Editar"> <i class="ti-pencil"></i>  </a>';
            }
        },{
                "targets": 2,
                "data": "IsActive",
